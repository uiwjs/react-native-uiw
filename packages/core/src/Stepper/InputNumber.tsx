...
> extends React.Component<P, S> {
  ...
  UNSAFE_componentWillReceiveProps(nextProps: P) {
    if ('value' in nextProps) {
      const value = this.state.focused ? nextProps.value : this.getValidValue(nextProps.value);
      this.setState({
        value,
        inputValue: value,
      });
  ...
  render() {
    ...
    console.log('inputStyle', this.props);
    ...
    return (
      <View style={[styles.container, style]}>
        ...
        <TouchableWithoutFeedback
          ...
          accessibilityState={{ disabled: !editable || !!downDisabledStyle }}
        >
          <View ref={(component) => (this._stepUp = component)} style={[styles.stepWrap, upDisabledStyle, upStyle]}>
            <Text ref={(component) => (this._stepUpText = component)} style={[styles.stepText, upDisabledTextStyle]}>
              +
            </Text>
          </View>
        </TouchableWithoutFeedback>
