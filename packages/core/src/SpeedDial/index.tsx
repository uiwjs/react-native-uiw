...
function SpeedDial(props: SpeedDialProps) {
  const { icon = ['plus', 'close'], style, onOpen, onClose, children = new Array<SpeedDialItemProps>(), transitionDuration = 200, isDrag = false, bottom = 350, right = 40, ...other } = props
