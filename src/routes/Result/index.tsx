...
import { List, Icon, Spacing, Del, Result } from '../../../components';
      ...
      <Container>
        <Layout>
          ...
          <Body>
            ...
            <Result
              img={
                <Icon name="time" size={60} fill='#1EABCD' />
              }
              title="等待处理"
            ...
            <Result
              img={
                <Icon name="circle-check" size={60} fill='#008EF0' />
              }
              title="验证成功"
            ...
            <Result
              img={
                <Icon name="circle-close" size={60} fill='#dc3545' />
              }
              title="支付失败"
              message="所选银行卡余额不足"
            />
            ...
            <Result
              img={
                <Icon name="warning" size={60} fill='#ffc107' />
              }
              title="无法完成操作"
