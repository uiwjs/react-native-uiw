  ...
  render() {
    ...
    return (
      <View style={{marginTop: 10, paddingLeft: 16, paddingRight: 16}}>
        <NoticeBar onPress={() => console.log('click')} marqueeProps={{loop: true, style: {fontSize: 12, color: 'red'}}}>
        ...
        <Spacing />
        <NoticeBar mode="link" action={<Text style={{color: 'blue'}}>去看看</Text>}>
          Change `Prompt` color
        </NoticeBar>
        <Spacing />
        <NoticeBar mode="link" icon={newCustomIcon} textStyle={{color: 'blue', fontSize: 20}} style={{backgroundColor: 'lightblue', height: 50}}>
