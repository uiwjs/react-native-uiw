...
import {List, Icon, Badge, Text} from '@uiw/react-native';
        ...
        <Layout>
          ...
          <Body>
            <List flat={false} extra="test">
              <List.Item extra={<Icon name="right" fill="#abb0b5" size={14} />} onPress={() => navigation.goBack()}>
                <Text color="text">这6种编码方法，你掌握了几个？</Text>
              </List.Item>
              <List.Item extra={<Icon name="apple" size={14} />}>
                <Text color="text">Protobuf 生成 Go代码指南</Text>
              </List.Item>
              <List.Item extra="说明">
                <Text color="text">Git 版本控制的核心概念</Text>
              </List.Item>
              <List.Item extra={<Icon name="right" fill="#abb0b5" size={14} />}>
                <Text color="text">HTTP Referer 和 Referrer Policy</Text>
              </List.Item>
              <List.Item>
                <Icon name="apple" size={14} />
                <View>
                  <Text color="text">因为爱过，所以慈悲；因为懂得，所以宽容。</Text>
                </View>
              </List.Item>
            </List>
            <List flat={false} extra={<Icon name="right" fill="#abb0b5" size={14} />} title="展示箭头">
            ...
            <List flat={false} extra={<Icon name="right" fill="#abb0b5" size={14} />} title="单元格大小">
            ...
            <List flat={false} size="small" extra={<Icon name="right" fill="#abb0b5" size={14} />} title="单元格大小">
