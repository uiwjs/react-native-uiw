import { View,Text, StyleSheet, Picker, TouchableHighlight, StyleProp, TextStyle } from "react-native";
...
export default class SelectCascader extends Component<ISelectCascaderProps, Istate> {
  ...
  getCols = () => {
    ...
    return childrenTree.map((children: any[] = [], level) => (
      <Picker
        ...
        onValueChange={(itemValue, itemPosition) => this.onValueChange(itemValue, level)}
  ...
  render() {
    const { title, dismissText, okText, onOk, onDismiss } = this.props;
